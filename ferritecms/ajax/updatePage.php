...
switch ($update) {
    case 'content':
        Pages::updatePage($page->id, $page->title, $content, $page->slug);
        break;
    
    case 'title':
        Pages::updatePage($page->id, $content, $page->content, $page->slug);
        break;
    
    case 'slug':
        Pages::updatePage($page->id, $page->title, $page->content, $content);
        break;
